...
Real name: lichengcai(suimi)<lichengcai@primeledger.cn>
Invalid character in name
Real name: lichengcai
Email address: lichengcai@primeledger.cn
Comment: suimi
You selected this USER-ID:
    "lichengcai (suimi) <lichengcai@primeledger.cn>"
...
uid                  lichengcai (suimi) <lichengcai@primeledger.cn>
...
gpg: key 1AFEE421: "lichengcai (suimi) <lichengcai@primeledger.cn>" not changed
...
```
language: java
#只有master,release-*,release_*,dev-*,dev-*才会执行
branches:
  only:
    - master
    - /^release(-|_).*$/
...
script: mvn package -DskipTests=true -Dmaven.javadoc.skip=true
